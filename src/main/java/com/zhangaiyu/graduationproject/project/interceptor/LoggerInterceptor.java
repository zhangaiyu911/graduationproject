...
import com.zhangaiyu.graduationproject.project.jpa.LoggerJPA;
...
public class LoggerInterceptor implements HandlerInterceptor {
    ...
    /**
     * 进入springMVC的Controller之前开始记录实体
     * @param request
     * @param response
     * @param o
     * @return
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {
        ...
        //设置请求时间差
        loggerEntity.setTimeConsuming(Integer.valueOf((int) (currentTime - time))+"");
        //设置返回时间
